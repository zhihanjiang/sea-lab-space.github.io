...
social:
  - icon: globe
    icon_pack: fas
    link: 'https://www.linkedin.com/in/yuang-fan/'
  - icon: envelope
    icon_pack: fas
    link: 'mailto:yf2676@columbia.edu'
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.com/citations?user=o9MbjYQAAAAJ&hl=en
  # - icon: github
  #   icon_pack: fab
